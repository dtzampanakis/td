...
class Turret(pg.sprite.Sprite):
    ...
    def update(self, enemy_group, world):
        ...
        if self.target:
            ...
            if (pg.time.get_ticks() - self.last_shot) > (self.cooldown / (world.game_speed * 2)):
    ...
    def play_animation(self, worldspeed):
        ...
        if pg.time.get_ticks() - self.update_time > c.ANIMATION_DELAY / worldspeed:
            self.update_time = pg.time.get_ticks()
            self.frame_index += 1
